      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="space-y-3 md:space-y-4">
          {Object.entries(categoryMap).map(([category, products]) => (
            <Card
              key={category}
              className="bg-gradient-to-br from-gray-900 via-gray-900 to-gray-950 border border-gray-700 rounded-2xl overflow-hidden shadow-2xl hover:shadow-blue-900/20 transition-all duration-300"
            >
              {/* CATEGORY HEADER */}
              <CardHeader
                onClick={() => toggle(category)}
                className="cursor-pointer p-5 md:p-6 bg-gradient-to-r from-gray-800/50 to-gray-900/50 hover:from-gray-700/50 hover:to-gray-800/50 backdrop-blur-sm transition-all duration-300 border-b border-gray-700/50"
              >
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div
                      className={`p-2 rounded-lg bg-blue-600/10 border border-blue-500/30 transition-all duration-300 ${
                        expandedCategory === category
                          ? "rotate-180 bg-blue-600/20"
                          : ""
                      }`}
                    >
                      <svg
              ...
              {expandedCategory === category && (
                <CardContent className="p-5 md:p-7 bg-gradient-to-b from-gray-950 to-black">
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-5 md:gap-6">
                    {products.map((p) => {
                      ...
                      return (
                        <Card
                          key={p._id}
                          className="bg-gradient-to-b from-gray-900 to-black border border-gray-700 rounded-2xl overflow-hidden group hover:border-blue-500/50 hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-300 flex flex-col h-full transform hover:-translate-y-1"
                        >
                          {/* Image */}
                          ...
                          <CardContent className="p-5 flex flex-col flex-1">
                            <CardTitle className="text-base md:text-lg mb-4 text-white h-14 flex items-center font-bold">
                              {p.title}
                            </CardTitle>

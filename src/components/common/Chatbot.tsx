...
// Simple FAQ knowledge base for demo Q&A
const KB: { keywords: string[]; answer: string }[] = [
  ...
  {
    keywords: ["407", "ultra", "lcv", "icv", "mcv", "lpt", "1518", "1412", "1618"],
    answer:
            ...
            <div className="border-b bg-card/80 backdrop-blur supports-[backdrop-filter]:bg-card/60">
              <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Ask about models, prices, finance, service and more</p>
                </div>
                <div className="flex items-center gap-2">
                  <Button variant="secondary" size="sm" onClick={() => { setOpen(false); openEnquiryDialog(); }}>
                    Enquire Now
                  </Button>
            ...
            <div className="mx-auto grid h-[calc(70vh-65px)] max-w-5xl grid-cols-1 gap-4 px-4 py-4 md:grid-cols-3">
              ...
              <aside className="hidden h-full flex-col rounded-md border bg-card p-4 md:flex">
                ...
                <div className="mt-4 rounded-md bg-muted p-3 text-xs text-muted-foreground">
                  Tip: You can also tap Enquire Now for a quick call-back from our team.
                </div>
              </aside>
            </div>
          </div>
